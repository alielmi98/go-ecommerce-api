...
import (
	...
	config "github.com/alielmi98/go-ecommerce-api/config"
...
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/shop/files/{id} [delete]
// @Security AuthBearer
func (h *FileHandler) Delete(c *gin.Context) {
	...
	if err != nil {
		log.Printf("Caller:%s Level:%s Msg:%s", constants.IO, constants.RemoveFile, err.Error())
...
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/shop/files/get-by-filter [post]
// @Security AuthBearer
