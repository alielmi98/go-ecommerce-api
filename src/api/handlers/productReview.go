...
// @Router /v1/product-reviews/ [post]
// @Security AuthBearer
...
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/product-reviews/{id} [put]
// @Security AuthBearer
...
// @Success 200 {object} helper.BaseHttpResponse{result=dto.ProductReviewResponse} "ProductReview response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/product-reviews/{id} [delete]
// @Security AuthBearer
...
// @Success 200 {object} helper.BaseHttpResponse{result=dto.ProductReviewResponse} "ProductReview response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/product-reviews/{id} [get]
// @Security AuthBearer
...
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
// @Router /v1/product-reviews/get-by-filter [post]
// @Security AuthBearer
